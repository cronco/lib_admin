...
def looks_like_isbn(isbn):
	"""Check to see if a string is composed of only digits and hyphens, and doesn't end in hyphens"""

	a = set([str(x) for x in range(0, 10)])
	a.add('-')
	return set(isbn).issubset(a) 
